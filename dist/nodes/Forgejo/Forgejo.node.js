...
exports.Forgejo = void 0;
// Helper function to fetch all pages
async function fetchAllPages(context, baseUrl, endpoint, method, qs, body, limit) {
    const allResults = [];
    let page = 1;
    ...
    while (hasMorePages) {
        ...
        const response = await context.helpers.httpRequestWithAuthentication.call(context, 'forgejoApi', requestOptions);
            ...
            try {
                ...
                if (resource === 'repository') {
                    if (operation === 'create') {
                        ...
                        const isPrivate = this.getNodeParameter('private', i);
                        const autoInit = this.getNodeParameter('autoInit', i);
                        body = {
                            name,
                            description,
                            private: isPrivate,
                        ...
                        const repo = this.getNodeParameter('repository', i);
                        ...
                        const page = additionalOptions.page || 1;
                        ...
                        const content = this.getNodeParameter('content', i);
                        const message = this.getNodeParameter('message', i);
                        const sha = this.getNodeParameter('sha', i);
                        endpoint = `/repos/${owner}/${repo}/contents/${filePath}`;
                        body = {
                            content: Buffer.from(content).toString('base64'),
                            message,
                ...
                // ===============================================
                    ...
                    if (operation === 'create') {
                        ...
                        const repo = this.getNodeParameter('repository', i);
                        const title = this.getNodeParameter('title', i);
                        const head = this.getNodeParameter('head', i);
                        const base = this.getNodeParameter('base', i);
                        const bodyContent = this.getNodeParameter('body', i);
                        const assignees = this.getNodeParameter('assignees', i);
                        ...
                        const owner = this.getNodeParameter('owner', i);
                        const repo = this.getNodeParameter('repository', i);
                        const prNumber = this.getNodeParameter('pullRequestNumber', i);
                        ...
                        const repo = this.getNodeParameter('repository', i);
                        const prNumber = this.getNodeParameter('pullRequestNumber', i);
                        const mergeMethod = this.getNodeParameter('mergeMethod', i);
                ...
                // ===============================================
                    ...
                    if (operation === 'create') {
                        ...
                        const name = this.getNodeParameter('name', i);
                        const bodyContent = this.getNodeParameter('body', i);
                        const draft = this.getNodeParameter('draft', i);
                        const prerelease = this.getNodeParameter('prerelease', i);
                ...
                // ===============================================
                    ...
                    if (operation === 'create') {
                        ...
                        const sourceBranch = this.getNodeParameter('sourceBranch', i);
                        ...
                        const repo = this.getNodeParameter('repository', i);
                        const branchName = this.getNodeParameter('branchName', i);
                        const protectionSettings = this.getNodeParameter('protectionSettings', i);
                ...
                // ===============================================
                    ...
                    if (operation === 'get') {
                        ...
                        const repo = this.getNodeParameter('repository', i);
                        const sha = this.getNodeParameter('sha', i);
                        const statusState = this.getNodeParameter('statusState', i);
                ...
                if (isPaginatedOperation) {
                    ...
                    response = await this.helpers.httpRequestWithAuthentication.call(this, 'forgejoApi', requestOptions);
                }
                // Handle the response
                if (Array.isArray(response)) {
